...
# =====================================================
# 🔧 Firebase & 共通ユーティリティ（ここだけ常時 import）
# =====================================================
from firebase_utils import (
    verify_password,
    update_user_password,
...
# ===============================
    ...
    # ✅ 未読数
    #   ※ admin_inbox の count_unread_messages を動的 import
    from admin_inbox import count_unread_messages as _count_unread_messages

    unread = _count_unread_messages()
    inbox_label = f"受信ボックス（{unread}）" if unread > 0 else "受信ボックス"
    ...
    # -------------------------------
    # 📋 登録済みユーザー一覧（firebase_utils だけ利用）
    # -------------------------------
    elif mode == "登録済みユーザー一覧":
        st.markdown("#### 👥 Firestore 登録済みユーザー一覧")
        df = fetch_all_users()
    ...
    # -------------------------------
    # 💬 チャット管理（呼ばれたときだけ admin_chat を import）
    # -------------------------------
    elif mode == "チャット管理":
        # 📩 受信BOXから遷移した場合
        if st.session_state.get("just_opened_from_inbox", False):
    ...
    # -------------------------------
    # 📥 受信BOX（呼ばれたときだけ admin_inbox を import）
    # -------------------------------
    elif mode == "受信ボックス":
    ...
    # -------------------------------
    # ⏰ 送信予約（呼ばれたときだけ admin_schedule を import）
    # -------------------------------
    elif mode == "送信予約":
        from admin_schedule import show_schedule_main
    ...
    # -------------------------------
    #  保護者未読一覧（呼ばれたときだけ unread_guardian_list を import）
    # -------------------------------
    elif mode == "保護者未読一覧":
        from unread_guardian_list import show_unread_guardian_list
...
# ===============================
    ...
    if not doc.exists:
        ...
        # ===============================
        # 💬 チャットページ（呼ばれたときだけ user_chat を import）
        # ===============================
        elif st.session_state["student_page"] == "chat":
            from user_chat import show_chat_page, get_user_meta
        ...
        # ===============================
        # 📝 英作文添削ページ（呼ばれたときだけ english_corrector を import）
        # ===============================
        elif st.session_state["student_page"] == "essay":
            from english_corrector import show_essay_corrector
        ...
        # ===============================
        # 🎧 英会話トレーナーページ（呼ばれたときだけ english_conversation を import）
        # ===============================
        elif st.session_state["student_page"] == "conversation":
            from english_conversation import show_english_conversation
